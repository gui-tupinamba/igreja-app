...
use App\Repository\MinistryScheduleRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MinistryScheduleRepository::class)]
#[ORM\Table(name: 'ministry_schedules')]
#[ORM\Index(name: 'idx_schedules_upcoming', columns: ['status', 'starts_at', 'id'])]
#[ORM\Index(name: 'idx_schedules_ministry_upcoming', columns: ['ministry_id', 'status', 'starts_at', 'id'])]
#[ORM\Index(name: 'idx_schedules_creator', columns: ['created_by'])]
class MinistrySchedule
{
    ...
    #[ORM\Column(length: 16, enumType: ScheduleStatus::class)]
    ...
    {
        $this->description = Guard::optionalText($description, 50000);
        $this->touch();
    }
