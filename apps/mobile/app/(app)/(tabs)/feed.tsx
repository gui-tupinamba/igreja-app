...
export default function Feed() {
  ...
  const canCreate = !!access.data && (access.data.permissions.manage_ministries || access.data.permissions.led_ministries.length > 0);
  ...
  return <Screen>
    ...
    {canCreate ? <Pressable accessibilityRole="button" onPress={() => router.push("/(app)/post/create")} style={styles.createButton}><Text style={styles.createButtonText}>+ Nova publicação</Text></Pressable> : null}
